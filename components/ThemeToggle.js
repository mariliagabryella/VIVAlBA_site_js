...
export default function ThemeToggle(){
    ...
    return(
        <button
          ...
          className="p-2 rounded-xl bg-gray-100 dark:bg-gray-800 hover:ring-2 hover:ring-blue-500 transition-all"
          aria-label="Alternar Tema"
          >
            {theme === "dark"? (
                //icone de sol
                <svg className="w-5 h5 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
